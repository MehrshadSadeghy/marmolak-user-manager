...
class V2RayClientCredentialORM(Base):
    __tablename__ = "v2ray_client_credentials"
    __table_args__ = (
        UniqueConstraint("server_id", "email", name="uq_v2ray_server_email"),
        UniqueConstraint("user_id", "server_id", "slot_index", name="uq_v2ray_user_server_slot"),
    )
